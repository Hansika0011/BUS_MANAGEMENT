...
<body>
    <div class="container">
        ...
        <form action="delete_admin_process.php" method="post">
            <div class="form-group">
                ...
                <select id="admin_id" name="admin_id">
                    ...
                    $sql = "SELECT admin_id, CONCAT(a_first_name, ' ', a_middle_name, ' ', a_last_name) AS full_name FROM admin";
            ...
            <button type="submit" class="button">Delete Admin</button>
            <button type="button" class="button" onclick="window.history.back()" style="margin-left: 73%;">Back</button>
