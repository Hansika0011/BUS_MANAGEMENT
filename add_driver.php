...
<body>
    ...
    <select id="gender" name="gender" required>
        ...
        if ($row && isset($row['d_gender'])) {
            // Output select options with selected attribute based on $row['d_gender']
            ?>
            ...
            // If $row is not set or null, output default select options
            ?>
...
<div class="form-group">
            ...
            <a href="#" class="button" onclick="history.back()" style="margin-left: 74%;">Back</a>
        </form>
    </div>
</body>
</html>
